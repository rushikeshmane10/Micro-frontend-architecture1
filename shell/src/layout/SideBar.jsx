...
export const Sidebar = () => {
  ...
  return (
    <div className="flex h-screen">
      {/* Main Sidebar */}
      <div className="w-20 flex flex-col bg-gradient-to-b from-gray-900 to-gray-950 text-white border-r border-gray-700">
        <div className="flex flex-col py-4 space-y-2 items-center">
          {menuItems.map((item) => (
            <button
              key={item.label}
              onClick={() =>
      ...
      {/* Sub Sidebar */}
      <div
        className={`overflow-hidden bg-gradient-to-b from-gray-900 to-gray-950 text-white border-r border-gray-700 transition-all duration-500 ease-in-out ${
          activeSection &&
